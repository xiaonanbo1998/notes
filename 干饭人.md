...
1. 走接口dev
   - 路径和参数之间，直接【?id=1】
   - 路径最后，不需要【/】
   - 参考写法：![image-20210917142946859](C:\Users\zyc\AppData\Roaming\Typora\typora-user-images\image-20210917142946859.png)
2. 走模型devcon
   - 路径和参数之间，间隔【/?id=1】
   - 路径最后，需要【/】
   - 参考写法：![image-20210917142925803](C:\Users\zyc\AppData\Roaming\Typora\typora-user-images\image-20210917142925803.png)
3. 其他
   - put数据的时候，表格不需要【s】
   - 外键，作为字段名的时候，加上【_id】
